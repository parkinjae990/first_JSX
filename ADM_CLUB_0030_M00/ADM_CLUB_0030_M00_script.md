...
this.fn_save = function () {
	...
	this.gfn_saveRow(this.ds_list, function (oData) { // grid를 선택할 수 있지만 rowCount를 가져오지 못하기에, ds_list로 대신할 수 있다. 
...
this.fn_delete = function()
{
	...
	this.gfn_deleteRow(this.ds_list, function (oData){ // grid를 선택할 수 있지만 rowCount를 가져오지 못하기에, ds_list로 대신할 수 있다.  
		oData.sController = ComService.$.CONTROLLER;	
		oData.svcList = [
				{
